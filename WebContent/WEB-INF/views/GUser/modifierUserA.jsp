...
<body>
	...
	<div class="row">
		<div class="container well">
			<h4 class="titre">
				<span class="glyphicon glyphicon-pencil"></span> Modifier les
				informations d'un utilisateur
			</h4>
			<hr>
			<form class="form" method="post" id="form"
				action='<c:url value="/compte?action=modif"></c:url>'>
				<div class="row">
					<div class="form-group">
						...
						<div class="col-lg-3 col-sm-2 ">
							<select name="userType" id="userType" class="form-control">
								<option value="${sessionScope.user.userType.id}" selected="selected">${sessionScope.user.userType.libelle}</option>
				...
				<div class="row">
					<div class="form-group">
						<label for="nom" class="col-lg-2">Nom <span
							class="requis">*</span></label>
						<div class="col-lg-3 col-sm-2 ">
							<input id="nom" name="nom" type="text" class="form-control"
								placeholder="Nom"
								value='<c:out value="${sessionScope.user.nom}"></c:out>'>
						</div>
						<div class="col-lg-4 col-sm-2 ">
					...
					<div class="form-group">
						...
						<div class="col-lg-3 col-sm-2 ">
							<input id="prenom" name="prenom" type="text" class="form-control"
								placeholder="Prénom"
								value='<c:out value="${sessionScope.user.prenom}"></c:out>'>
						</div>
						<div class="col-lg-4 col-sm-2 ">
							<span class="erreur"><c:out
					...
					<div class="form-group">
						...
						<div class="col-lg-3 col-sm-2 ">
							<input id="login" name="login" type="text" class="form-control"
								placeholder="Login"
								value='<c:out value="${sessionScope.user.login}"></c:out>'>
						</div>
						<div class="col-lg-4 col-sm-2 ">
							<span class="erreur"><c:out
