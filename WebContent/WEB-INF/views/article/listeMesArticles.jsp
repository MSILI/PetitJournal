	...
	<div class="row">
		<div class="container well">
			<h4 style="color: rgb(228, 79, 80); font-weight: bold;">
				<span class="glyphicon glyphicon-list"></span> Mes porpres articles
			</h4>
			<hr>
			<c:if test="${empty listeArticlesMinde }">
				<p class="errorlogin">Il n'existe aucun article de vous pour
					l'instant !</p>
			</c:if>
			<c:if test="${!empty listeArticlesMinde }">
				<div class="row">
				...
				<div class="table-responsive">
					<table id="table"
						...
						<tbody class="searchable">
							<c:forEach items="${ listeArticlesMinde }" var="listArt"
								varStatus="boucle">
								<tr>
										...
										<div class="row">
											<p class="col-lg-8 col-sm-8 col-xs-5 txt-art">
												<span class="comment more"> <c:out
														value="${listArt.text}"></c:out>
												</span> <br> <br> <a class="btn btn-default"
